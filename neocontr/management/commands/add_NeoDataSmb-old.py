...
ContrFile = '/home/tank/znw_contract_list.csv'
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        #The Field having value ="string"
        CleanDataField = ['受注番号','客先注文番号','受注品番','本体SN','仕入品番','本体交換履歴','ContractNo']
        ...
        #    df = pd.read_csv("znw_contract_list.csv", sep=",",encoding="cp932",usecols=OriginHeader,parse_dates=FieldofDate,na_filter=False,converters={'受注枝番': strip_spaces,'サブキー番号':strip_spaces})
             df = pd.read_csv(ContrFile, sep=",",encoding="cp932",usecols=OriginHeader,parse_dates=FieldofDate,na_filter=False)
        ...
        #Step3 : Remove ="" from ="string" cell to string cell 
        for i in CleanDataField:
        ...
        ##Step4 :Input the dataframe's data to Model's database by converting dataframe to sql.

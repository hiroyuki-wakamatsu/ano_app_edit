...
console.log("Linkクリック");
  ...
  /*
  // clickイベントをdocumentにデリゲート
  $(document).on('click', '#mainLink', function(e) {
    // mainLinkクリック時の処理をここに記述
    console.log("click mainLink");
    addRow("mainLink");

  });
  $(document).on('click', '#notesLink', function(e) {
   // notesLinkクリック時の処理をここに記述
   console.log("click notesLink");
  });
  $(document).on('click', '#confirmLink', function(e) {
    // confirmLinkクリック時の処理をここに記述
    console.log("click confirmLink");
  });
  */
